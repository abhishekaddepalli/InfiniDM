...
/**
 * A live recurring subscription. The gateway charges the customer automatically
 * each cycle and fires a renewal webhook; we then extend the buyer's
 * plan_ends_at by one more period (see SubscriptionService). This is how paid
 * plans auto-renew WITHOUT a Laravel scheduler — the gateway is the clock, the
 * webhook is the tick.
 *
 ...
 *
 * INSTAFLOW NOTE: workspace_id is a plain column (no Workspace model). The plan
 * window itself lives on users.plan_ends_at (see SubscriptionService).
 */
