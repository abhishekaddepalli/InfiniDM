@props([
    /** Page title (also used in <title> tag by the extending blade). */
    'title' => 'Legal',
    ...
    <div class="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-7 py-16 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <aside class="col-span-12 lg:col-span-3">
            <div class="lg:sticky lg:top-24">
                <div class="mono text-[10px] uppercase tracking-widest text-ink-500 mb-4">{{ __('Contents') }}</div>
                ...
                <div class="hairline rounded-2xl bg-paper-50 p-4 mt-8">
                    <div class="mono text-[10px] uppercase tracking-widest text-ink-500 mb-2">{{ __('Questions?') }}</div>
...
@push('scripts')
    <style>
        .legal-prose .prose-body p { margin: 0 0 1em; }
        .legal-prose .prose-body ul,
        .legal-prose .prose-body ol { margin: 0 0 1em 1.5em; list-style: disc; }
        .legal-prose .prose-body ol { list-style: decimal; }
        .legal-prose .prose-body li { margin-bottom: 0.4em; }
        .legal-prose .prose-body strong { color: #1A1320; font-weight: 600; }
        .legal-prose .prose-body a { color: #C13584; text-decoration: underline; text-underline-offset: 3px; }
        .legal-prose .prose-body h3 { font-family: 'Instrument Serif', serif; font-size: 22px; margin: 1.5em 0 .6em; }
        .legal-prose .prose-body code { font-family: 'JetBrains Mono', monospace; font-size: 12.5px; background: #F4EFF6; padding: 1px 6px; border-radius: 4px; }
    </style>
@endpush
