@props([
    ...
    'authorRole' => 'Founder, Bloom Studio · Mumbai',
    'authorInitials' => 'PR',
...
@php
    $quote =
        $quote ??
        __(
            'We replaced ManyChat, a spreadsheet, and a part-time VA. Story-reply automation pushed our DM reply rate from <span class="italic">21%</span> to <span class="italic text-wa-deep">88%</span> — and every comment now turns into a conversation. Sales are up, and I sleep again.',
        );
    $stats = $stats ?? [
        ['label' => __('tools replaced'), 'value' => '3 → 1'],
        ['label' => __('DM → sale'), 'value' => '+41%'],
    ];
@endphp
