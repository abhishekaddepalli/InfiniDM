<x-layouts.admin :title="__('Admin · Edit announcement')" admin-key="announcements">
    ...
    <div class="px-4 sm:px-6 lg:px-7 pt-7 pb-2">
        <div>
            ...
            <h1 class="font-serif font-normal tracking-[-0.01em] text-[28px] sm:text-[32px] lg:text-[36px] leading-[1.0]">{{ __('Edit') }} <span
                    class="italic ig-text">{{ __('announcement') }}</span></h1>
            <p class="text-[13px] text-ink-600 mt-2 max-w-2xl">
                {{ __('Changes take effect immediately in the marquee bar.') }}
            </p>
        </div>
    </div>
